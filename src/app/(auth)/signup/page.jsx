    ...
    <div className="relative min-h-screen flex items-center justify-center p-4 overflow-hidden text-slate-300">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm">Join the community of elite developers.</p>
        </div>
        ...
        <form className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative group">
              <User className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-violet-400 transition-colors" size={18} />
              <input 
                type="text" 
          ...
          {/* Submit Button */}
          <button type="button" className="w-full btn-primary py-3 shadow-lg shadow-violet-500/20 mt-2">
            Create Account
          </button>
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-[#121b36] px-2 text-slate-500 rounded-full border border-white/5">Or sign up with</span>
          </div>
        </div>
